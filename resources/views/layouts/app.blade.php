...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="font-sans antialiased bg-[#0f0f0f] text-white" x-data="{ 
        ...
        <div class="flex min-h-screen">
            ...
            <aside class="w-64 bg-[#141414] border-r border-neutral-900 flex flex-col justify-between p-4 shrink-0">
                <div>
                    <div class="mb-6 px-2">
                        ...
                        <span class="text-[10px] text-gray-500 block pl-7 -mt-1">Santa Ana, El Salvador</span>
                    </div>
                ...
                <div class="border-t border-neutral-900 pt-4 flex items-center gap-3 px-2">
                    <div class="w-9 h-9 rounded-full bg-brand-neon text-black font-bold flex items-center justify-center text-xs" x-text="memberData.name.split(' ').map(n => n[0]).join('')">
                        </div>
            ...
            <main class="flex-1 flex flex-col min-w-0 bg-[#0c0c0c]">
                ...
                <header class="h-14 border-b border-neutral-900 flex items-center justify-end px-6 gap-4 relative">
        ...
        <div x-show="openEditProfile" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm" x-cloak>
            <div @click.away="openEditProfile = false" class="bg-[#141414] border border-neutral-800 w-full max-w-lg rounded-2xl overflow-hidden shadow-2xl">
                ...
                <form @submit.prevent="openEditProfile = false" class="p-6 space-y-4">
                    <div>
